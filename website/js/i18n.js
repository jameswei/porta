const translations = {
  en: {
    ...
    cap9Title:      "Smart System Exclusion",
    cap9Desc:       "14 known macOS system daemons (ControlCenter, mDNSResponder, rapportd, and more) are always hidden, keeping the list focused on your dev processes.",
  ...
  zh: {
    ...
    cap9Title:      "智能系统进程屏蔽",
    cap9Desc:       "自动隐藏 14 个已知 macOS 系统守护进程（ControlCenter、mDNSResponder、rapportd 等），让列表始终聚焦在你的开发进程上。",
    stackTitle:     "技术栈",
